...
class AccessoriesControllerTest < ActionController::TestCase
  ...
  test "should create accessory" do
    assert_difference('Accessory.count') do
      post :create, accessory: { compatible: @accessory.compatible, description: @accessory.description, features: @accessory.features, name: @accessory.name, price: @accessory.price }
    end
  ...
  test "should update accessory" do
    patch :update, id: @accessory, accessory: { compatible: @accessory.compatible, description: @accessory.description, features: @accessory.features, name: @accessory.name, price: @accessory.price }
    assert_redirected_to accessory_path(assigns(:accessory))
  end
